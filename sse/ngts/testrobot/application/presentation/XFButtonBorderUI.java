package sse.ngts.testrobot.application.presentation;
        ...
        extends AbstractBorder implements UIResource
{
    ...
    private void drawActiveButtonBorder(Graphics g, int x, int y, int w,
                                        int h)
    {
        drawFlush3DBorder(g, x, y, w, h);
    ...
    private void drawDefaultButtonBorder(Graphics g, int x, int y, int w,
